...
def init_globals():
    """Initialize global variables for the GUI."""
    global root, tk_frame, dt_string
...
def run_script(user_selection):
    """Main function to run backup based on user selection."""
        ...
        with open(file_path, "r") as read_obj:
            ...
            while rows >= 2:
                ...
                if ip_ping == None:
                    ...
                    # Based on user selection, run the script in the vendor_backups folder.
                    if user_selection == "1":
                        cisco_ios.backup(
                            list_of_rows[rows][0],
                            list_of_rows[rows][1],
                        ...
                        juniper.backup(
                            list_of_rows[rows][0], list_of_rows[rows][1], list_of_rows[rows][2]
                        )
